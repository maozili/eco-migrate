...
import (
	...
	dStub "github.com/eco-migrate/migrate/v4/database/stub"
	"github.com/eco-migrate/migrate/v4/source"
	sStub "github.com/eco-migrate/migrate/v4/source/stub"
)
...
func ExampleNewWithDatabaseInstance() {
	...
	// `import "github.com/eco-migrate/migrate/v4/database/postgres"`
...
func ExampleNewWithSourceInstance() {
	...
	// `import "github.com/eco-migrate/migrate/v4/source/stub"`
